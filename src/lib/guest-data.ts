  ...
  items: [
    {
      ...
      unitSize: "4L",
      prices: {
        walmart:  { price: 5.47, scrapedAt: daysFromNow(-1) },
        dominion: { price: 6.29, scrapedAt: daysFromNow(-1) },
        sobeys:   { price: 5.99, scrapedAt: daysFromNow(-1) },
      },
      bestPrice: 5.47,
      bestStore: "walmart",
      notifyOnDrop: true,
    ...
    },
    {
      ...
      unitSize: "12 pack",
      prices: {
        walmart:  { price: 3.47, scrapedAt: daysFromNow(-1) }, // on sale
        dominion: { price: 4.69, scrapedAt: daysFromNow(-1) },
        sobeys:   { price: 4.29, scrapedAt: daysFromNow(-1) },
      },
      bestPrice: 3.47,
      bestStore: "walmart",
      notifyOnDrop: true,
...
const LIST_ITEMS = [
  {
    ...
    unitMeasure: "L",
    unitQuantity: 4,
    prices: [5.47, 6.29, 5.99, null] as [number | null, number | null, number | null, number | null],
  },
  {
    productId: "prod_eggs_burnbrae",
    name: "Burnbrae Eggs Large",
    ...
    unitMeasure: "unit",
    unitQuantity: 12,
    prices: [3.47, 4.69, 4.29, null] as [number | null, number | null, number | null, number | null],
  },
  {
    productId: "prod_bread_wonder",
    name: "Wonder White Bread",
