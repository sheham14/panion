  ...
  return (
    <div className="bg-white dark:bg-[#0f1416]">
      ...
      <button
        ...
        className={[
          "fixed right-[max(1rem,calc(50vw_-_13rem))] z-10 w-12 h-12 bg-[#00E5C3] rounded-full shadow-lg flex items-center justify-center active:scale-95 transition-all",
      ...
      {/* Bulk action bar */}
      {hasActions && (
        <div className="fixed bottom-above-nav left-1/2 -translate-x-1/2 w-full max-w-md bg-white dark:bg-[#1e2528] border-t border-[#ebebeb] dark:border-[#2e3538] px-4 py-3 flex gap-2 z-10">
          <button
